var sql = {
    ...
    shop_order_query: 'select orderno,price,userid,detail,status,createtime from t_order where shopid=? and from_unixtime(createtime,\'%Y%m%d\')=? order by createtime desc limit ?,?',
